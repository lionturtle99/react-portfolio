          ...
          <div className="col-md-6 mx-auto">
            <form action="https://formsubmit.co/liamthelastson@gmail.com" method="POST">
              ...
              <div className="mb-3">
                ...
                <input type="email" name="email-address" className="form-control" id="email-address" placeholder="example@gmail.com" required></input>
              </div>
              <div className="mb-3">
                <label for="email-body" className="form-label">Email Body</label>
                <textarea className="form-control" name="email-body" id="email-body" rows="3" placeholder="Hi Liam,&#10;&#10;My name is Natalie, pleased to meet you!" required></textarea>
              </div>
