      ...
      <div className="container my-5 py-5">
        ...
        <div className="row">
          <div className="col-md-4">
            <a className="github-repo-card" href="https://github.com/lionturtle99/TapRoom-React">
              <div className="card p-4">
                <img src={taproom} alt="hops wearing a crown and glasses"></img>
          ...
          <div className="col-md-4">
            <a className="github-repo-card" href="https://github.com/lionturtle99/Hogwarts-School-of-Magic">
              <div className="card p-4 text-center">
                <img src={hogwarts} alt="castle with with a lake and boats"></img>
                <div className="card-body">
          ...
          <div className="col-md-4">
            <a className="github-repo-card" href="https://github.com/lionturtle99/currency-exchange-API-week">
              <div className="card p-4">
                <img src={api} alt="application programming interface diagram"></img>
